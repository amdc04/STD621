...
if ($detect->isMobile() || $detect->isTablet() ) {
    $isMobile = true;
    $btnColor = 'color: #0D1B28 !important;';
    $navColor = "background-color: #0D1B28 !important; color:white !important;";
  ...
  <nav id="navigation_bar" class="navbar navbar-default  <?php $isMobile ? 'fixed-top shadowed' : ''?>" style="<?php echo $navColor ?>">
    <div class="<?php echo $container ?>">
      <div class="navbar-header" style="padding-left:2rem !important;">
        <button id="menu_slide" data-target="#navigation" aria-expanded="false" data-toggle="collapse" class="navbar-toggle collapsed" type="button" style="color:white !important; border: none !important; font-weight:600; top: -2px !important;">RentNow &nbsp; <i class='fa fa-car fa-sm'></i> </button>
      ...
      //     echo "
      //     <span class='navbar-text' style='position:absolute; text-align:left;color:white; left: 5% !important; top: 5px !important; font-weight:600;'>RentNow &nbsp; <i class='fa fa-car fa-sm'></i></span>
      //     ";
      // }
      ?>
  ...
  <?php
   ...
   <i class="fa fa-angle-down" aria-hidden="true"></i></a>
        ...
        <!-- <div class="header_search">
         ...
         <?php 
            if( $detect->isMobile() || $detect->isTablet() ){
                echo '<div class="ml-3  p-1" style="font-size:9px !important; color:#0D1B28;"></div>';
            }
        ?>
        
        
      </div>
      <div class="collapse navbar-collapse" id="navigation" style="background-color:#0D1B28;" >
